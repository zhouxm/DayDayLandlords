...
cc.Class({
  ...
  loadPlayerInfo() {
    ...
    cc.loader.loadRes('strings', function (err, res) {
      console.log('loadPlayerInfo res:', res);
      var names = res.json.name_list;
  ...
  initPlayers() {
    ...
    this.player1.node.setPosition(-350, -100);
    ...
    this.player2.node.setPosition(-350, 130);
    ...
    this.player3.node.setPosition(350, 130);
